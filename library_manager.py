...
if 'book removed' not in st.session_state:
    st.session_state.book_added=False
if 'current view' not in st.session_state:
    ...
    if stats['total_books']>0:
        ...
        if stats['genres']:
            ...
            fig_genres = px.bar(
                ...
                y='Count',
                color='Count',
                color_contonous_scale=px.colors.sequential.Blues
            )
...
lottle_book=load_lottieurl("https://assests9.lottiefiles.com/temp/1f20_akAfIn.json")
if lottie_book:
    with st.sidebar:
        st.lottie(lottie_book,height=200,key='book_animmation')
...
st.markdown("...")
st.markdown("Copyright @2025 Shahzaib Aslam Personal Library Manager",unsafe_allow_html=True)
